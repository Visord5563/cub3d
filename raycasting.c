...
/*   Updated: 2025/01/29 21:29:17 by saharchi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_y(t_map *p_map, double ray_angle)
{
    ...
    p_map->ray.x_inter = player_x + (p_map->ray.y_inter - player_y) / tan(ray_angle);
}
...
void get_x(t_map *p_map, double ray_angle)
{
	...
	p_map->ray.y_inter = player_y + (p_map->ray.x_inter - player_x) * tan(ray_angle);
}
